...
import br.com.maurireis.labs.communication.controller.v1.dto.mapper.MessageMapper;
import br.com.maurireis.labs.communication.controller.v1.dto.message.MessageDto;
import br.com.maurireis.labs.communication.controller.v1.dto.response.Response;
...
public class ScheduleController {
    ...
    public ResponseEntity<Response<MessageDto>>  create(@RequestBody @Valid MessageDto messageDto) {
        Response<MessageDto> response = new Response<>();
        final Message message = messageService.create(MessageMapper.DtoToMessage(messageDto));
        MessageDto dto = MessageMapper.messageToDto(message);
        createSelfLink(dto, message.getId());
        response.setData(dto);
